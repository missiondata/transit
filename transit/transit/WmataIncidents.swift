...
public extension Transit {
    ...
    public func getBusIncidents(_ routeId: String?, success: JSONSuccessHandler? = nil, failure: FailureHandler? = nil) {
    ...
    public func getElevatorAndEscalatorOutages(_ stationCode: String?, success: JSONSuccessHandler? = nil, failure: FailureHandler? = nil) {
        let path = "Incidents.svc/json/ElevatorIncidents?StationCode=\(stationCode != nil ? stationCode! : "")"
        self.getJSONWithPath(path, baseURL: self.apiURL, success: success, failure: failure)
    }
    
    public func getRailIncidents(_ success: JSONSuccessHandler? = nil, failure: FailureHandler? = nil) {
